			...
			<div class="col s12">
					...
					<div class="col s12">
						<div style="margin: 50px;">
							<span class="h3 center-align white-text" style="font-size: 40px"> Algoholic Part II </span>		
							<hr>			
						</div>
				...
				<div class="row">
					<div class="col s12 	">
							...
							<img src="Images/ALGO1.jpg" class="responsive-img" style="max-height: 400px;width: 100%">
...
For further enquiries contact:-<br>
	...
	Melita: 7709181931	<br>						</span>
          ...
          <span class="white-text desc"> Go to the Contest Page	</span> <a href="https://www.hackerrank.com/algoholic-2-0" class="btn right indigo darken-4">Hackerrank</a>			
				</div>
